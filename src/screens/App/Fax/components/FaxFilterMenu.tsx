...
type Props = {
  value: FaxFilter;
  onChange: (filter: FaxFilter) => void;
...
const FaxFilterMenu = ({ value, onChange, onOpenChange }: Props) => {
  ...
  return (
    <View style={[styles.host, open && styles.hostOpen]}>
      <Pressable
        ...
        accessibilityLabel="Filter faxes"
              ...
              {FILTER_OPTIONS.map((option, index) => {
                ...
                return (
                  <Pressable
                    ...
                    style={[
                      styles.option,
                      !isLastOption && styles.optionBorder,
                    ]}
...
export default memo(FaxFilterMenu);
