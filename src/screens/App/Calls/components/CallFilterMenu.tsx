...
import type { RecentCallsFilter } from "../data/callRecords";

type FilterOption = {
  id: RecentCallsFilter;
  label: string;
  icon: LucideIcon;
  color: string;
};
...
type Props = {
  ...
  onChange: (filter: RecentCallsFilter) => void;
...
type FilterOptionRowProps = {
  ...
  onSelect: (filter: RecentCallsFilter) => void;
};
...
const CallFilterMenu = ({ value, onChange, onOpenChange }: Props) => {
...
export default memo(CallFilterMenu);
